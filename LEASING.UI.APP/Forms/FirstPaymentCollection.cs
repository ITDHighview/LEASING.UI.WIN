...
{
    public partial class FirstPaymentCollection : Form
    {
        #region Context
        ...
        private bool _initPayment(FirstPaymentModeForm pForm)
        {
        ...
        private void _recievePayment(FirstPaymentReceiveCollection pForm)
        {
        ...
        private void _generatePaymentUnit()
        {
            ...
            {
                var fPayment = new FirstPaymentModeForm();
                if (!this._initPayment(fPayment))
                {
                    return;
                }

                var fReceivePayment = new FirstPaymentReceiveCollection();
