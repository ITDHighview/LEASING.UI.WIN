...
{
    public partial class PurchaseItemRegistrationForm : Form
    {
       private ProjectContext _project;
       private LocationContext _location;
       private PurchaseItemContext _purchase;
        public PurchaseItemRegistrationForm()
        {
        ...
        private void dgvPurchaseItemList_CellClick(object sender, Telerik.WinControls.UI.GridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    EditPurchaseItemForm forms = new EditPurchaseItemForm();
        ...
        {
            UnitBrowse forms = new UnitBrowse();
