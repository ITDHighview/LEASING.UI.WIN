...
{
    public partial class UnitRenewalContractRegistrationForm : Form
    {
        ...
        public UnitRenewalContractRegistrationForm()
        {
            InitializeComponent();
        }
        public bool sIsFullPayment = false;
        public bool IsComputed = false;
        private DataTable dtAdvancePayment = new DataTable();
        ...
        private void btnAddDiscount_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    AddDiscountInBaseRental frmdiscount = new AddDiscountInBaseRental();
