...
{
    public partial class ViewClientInfo : Form
    {
        ...
        private void dgvList_CellClick(object sender, Telerik.WinControls.UI.GridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                {
                    RecieptBrowse forms = new RecieptBrowse();
                ...
                else if (this.dgvList.Columns[e.ColumnIndex].Name == "ColAuthorization")
                {
                    if (dgvList.Rows.Count > 0)
                    {
                        ...
                        {
                            MoveInAuthorizationReport MoveIn = new MoveInAuthorizationReport(Convert.ToString(dgvList.CurrentRow.Cells["RefId"].Value));
                            MoveIn.Show();
                        }
                    }
                }
