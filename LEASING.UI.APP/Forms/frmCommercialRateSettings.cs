...
namespace LEASING.UI.APP.Forms
{
    public partial class frmCommercialRateSettings : Form
    {
        ...
        {
            string results = RateSettingsContext.UpdateCOMMERCIALSettings(txtGenVat.Text == string.Empty ? 0 : Convert.ToInt32(txtGenVat.Text), txtSecAndMaintenance.Text == string.Empty ? 0 : decimal.Parse(txtSecAndMaintenance.Text), txtWithHoldingTax.Text == string.Empty ? 0 : Convert.ToInt32(txtWithHoldingTax.Text));
