...
VALUES
    (
        1, 1, 1, 'radPanel2', 'CLEINT MAIN PANEL', 0, 1, 0
    ),
    (
        2, 1, 1, 'radMenuItemClient', 'CLEINT HEADER MENU ITEM', 1, 0, 0
    ),
    (
        3, 1, 1, 'radMenuItemAddNewClient', 'Add / Edit Client', 0, 0, 0
    ),
    (
        4, 1, 1, 'radMenuItemClientInformation', 'Client Information', 0, 0, 0
    ),
    (
