...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[sp_GetUnitById] @RecId INT
AS
    BEGIN
        ...
        SELECT
                ...
                ISNULL([tblUnitMstr].[IsNonVat], 0)                                 AS [IsNonVat],
                ...
                ISNULL([tblUnitMstr].[IsNonTax], 0)                                 AS [IsNonTax],
                ISNULL([tblUnitMstr].[IsNonCusa], 0)                                AS [IsNonCusa],
                ISNULL([tblUnitMstr].[IsNotRoundOff], 0)                            AS [IsNotRoundOff],
                ISNULL([tblUnitMstr].[IsOverrideSecAndMain], 0)                     AS [IsOverrideSecAndMain]
        FROM
                [dbo].[tblUnitMstr]
            INNER JOIN
                [dbo].[tblProjectMstr]
