...
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[sp_TerminateContract]
    @ReferenceID                VARCHAR(50)   = NULL,
    @EncodedBy                  INT           = NULL,
    @ComputerName               VARCHAR(20)   = NULL,
    @ContractTerminationRemarks NVARCHAR(300) = NULL
AS
    BEGIN TRY
        ...
        SET
            ...
            [tblUnitReference].[ContractTerminationRemarks] = @ContractTerminationRemarks
        WHERE
