...
-- =============================================
ALTER PROCEDURE sp_HoldPayment 
...
BEGIN
	...
	update tblMonthLedger set IsHold = 1 where Recid = @Recid and ReferenceID =(SELECT Recid FROM tblUnitReference where RefId =@ReferenceID)
